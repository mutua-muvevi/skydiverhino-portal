...
// sections
import ChatNav from "./nav/chat-nav";
import ChatRoom from "./room/chat-room";
import ChatMessageInput from "./message/chat-message-input";
import ChatMessageList from "./message/chart-message-list";
import ChatHeaderDetail from "./header/chart-header-detail";
import ChatHeaderCompose from "./header/chat-header-compose";
					...
					>
						<Stack flexGrow={1} sx={{ minWidth: 0 }}>
							...
							<ChatMessageInput
								...
								disabled={
									pathname === PATH_DASHBOARD.chat.root ||
									pathname === PATH_DASHBOARD.chat.new
								}
							/>
						</Stack>
